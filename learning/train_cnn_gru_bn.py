...
from utils import CaptchaDataset2, CaptchaModelBN, total_chars
...
# python train_cnn_gru_bn.py --epochs 200 --lr 0.00005 --batch_size 128 --hidden_size 512 --data_dir ../data --version 8
...
net = CaptchaModelBN(hidden_size=hidden_size).to(device)
