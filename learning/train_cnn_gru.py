...
from utils import CaptchaDataset2, CaptchaModel, total_chars
...
# python train_cnn_gru.py --epochs 200 --lr 0.00005 --batch_size 128 --hidden_size 256 --data_dir ../data --version 6
